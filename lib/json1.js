...
if (require.main === module) {
  ...
  // transform([[0,{"i":{"Jabberwock":"through","back":[[null],"its"]}}],[1,0,"he",{"es":[{"d":1},"arms that mimsy "]}]], [0,0,["beamish",{"i":"mimsy"}],["he",{"p":0}],["mome",{"d":0}]], "right")
  transform([
      [ 0, { i: "yo" } ],
      [ 1, 'a', { es: [] } ]
    ], [
  ...
  // apply([ [ { Did: '', mimsy: 23, mome: 'my', beamish: 'mimsy' } ] ],
  //   [ 0,
  //     { i: { Jabberwock: 'through', back: [ [ null ], 'its' ] } },
  //     0,
  //     'mome',
  //     { es: [ { d: 1 }, 'arms that mimsy ' ] } ]
  // )
}
