  ...
  function scanOp2Drop(r1Pick, r2Pick, r2Drop, removed1) { // r1Pick, r2Pick could be null.
    ...
    for (const key of r2Drop.children()) {
      if (typeof key === 'number') {
        ...
        const _p1Pick = ap1(p2Mid)

        log('-> k', key, 'p2Mid', p2Mid)
        ...
        { // Calculate _p1Pick and outPickOff
          ...
          while (p1pValid && typeof (p1k = p1Pick.getKey()) === 'number') {
            ...
            if (hp) {
              ...
              // logic above :(
              log('considering outPickOff--', c, cancelledRemoves)
      ...
      if ((slot = c2.d) != null) {
        ...
        if (_w) {
          ...
          if (parentC && check(readCursor(_w.get()))) {
            ...
            if (!removedOut) w.mergeTree(_w.get(), (c, w) => {
...
if (require.main === module) {
  ...
  // transform(["So",["mome",{"r":true},0,{"p":1}],["thought",["Beware",{"p":0}],["The",{"d":0}],["the",{"d":1}]]], ["So",["mome",1,{"d":0}],["thought",{"p":0},"Beware",{"r":true}]], "right")
  ...
  // transform([ 'Came', 0, [ 0, { r: true }, 'he', { p: 0 } ], [ 1, { d: 0 }, 0, { i: 'time' } ] ],
  //   [ 'Came', 0, [ 0, 'he', [ 0, { d: 0 } ], [ 1, { es: [] } ] ], [ 1, { p: 0 } ] ],
  //   'right')

  // transform(
  //   [ [ 0, [ 1, { p: 0 } ], [ 2, { r: true } ] ],
  // [ 1, 'went', [ 'frabjous', { d: 0 } ], [ 'vorpal', { r: true } ] ] ],
  //   [ [ 0,
  //   [ 1, { i: { Come: { frumious: 10 } }, p: 0 }, 'and', { d: 0 } ],
  //   [ 2, 'catch', { i: '' } ] ],
  // [ 1, 'went', 'vorpal', { r: true } ] ],
  //   'left'
  // )
