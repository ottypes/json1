...
const transform = type.transform = function(op1, op2, direction, opts) {
  ...
  function writeOp1Drop(p1Pick, p1Drop, p2Pick, p2Drop, w, removed2) {
    ...
    // Now we want to read both teleports for the edit component.
...
if (require.main === module) {
  ...
  transform([["x",{"p":0}],["y",{"d":0,"es":[1,"xxx"]}]], ["x",{"es":[{"d":2},"Z"]}], 'left')

  // transform(["x",{"es":[1, "ab"]}], [["x",{"p":0}],["y",{"d":0,"es":[{d:1},"cd"]}]], 'left')
  // transform(["x",{"es":[1, "ab"]}], [["x",{"p":0}],["y",{"d":0,"es":[{d:1},"cd"]}]], 'right')
