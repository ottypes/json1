...
if (require.main === module) {
  ...
  // apply( {"x":{"y":{"was":"y"},"was":"x"}}, [["X",{"d":0},"Y",{"d":1}],["x",{"p":0},"y",{"p":1}]] )
  type.apply({}, [{p:0}, 'a', {d:0}])
  // type.apply({x:{}}, ['x', {p:0}, 'a', {d:0}])
  // checkOp( [[1,{"r":true},1,{"p":0}],[2,{"d":0}]] )

  // checkOp([{r:true}, 1, {es:['hi']}])
  // transform([["",{"r":true}],["and",0,["gyre",{"p":0}],["manxome",{"d":0},"the","it",{"es":[]}]],["toves",{"i":"mimsy"}]],
  //   [["",{"r":true}],["And",{"i":48}],["and",0,"gyre",["the",["it",{"p":0}],["raths",{"i":null}]],["thought",{"d":0}]]], 'left')
}
