...
type.compose = function(op1, op2) {
  ...
  function xfBoundary(r1Pick, r1Drop, r2Pick, r2Drop, litIn, rmParent, wd, wp) {
    ...
    log('xfBoundary', litIn, !!r1Pick, !!r1Drop, !!r2Pick, !!r2Drop,
    ...
    eachChildOf(r1Drop, r2Pick, (k, c) => {
      ...
      const _lit = hasContainerLiteral ? litOut[inKey] : undefined
      ...
      if (hasContainerLiteral) {
        if (_lit !== _litResult) {
          mut()
          setOrRemoveChild(litOut, inKey, _litResult)
        }
    ...
    if (c2 && ((slot = c2.d) != null)) {
      ...
      if (_w) {
        ...
        if (parentC && check(readCursor(_w.get()))) {
          ...
          w.mergeTree(_w.get(), false, true) // only merge drops
