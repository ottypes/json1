...
const RM_EMBEDDED_EDIT = 'remove embedded edit'
...
const tryTransform = type.tryTransform = function(op1, op2, direction) {
  ...
  function scanOp2Drop(r1Pick, r2Pick, r2Drop, removed1) { // r1Pick, r2Pick could be null.
    log('scanOp2Drop', r1Pick && 'r1Pick', r2Pick && 'r2Pick', 'removed:', removed1 && removed1.getPath())
    log.prefix++
    ...
    if (c2d) {
      if (((slot2 = c2d.d) != null)) {
        ...
        if (cancelledOp2[slot2]) removed1 = heldOp1RmForOp2[slot2]
        else if (removed1) {
  ...
  function writeOp1Drop(p1Pick, p1Drop, p2Pick, p2Drop, w, removed2) {
    ...
    if (c1d) {
      ...
      if (c1d.i !== undefined || ((slot1 != null) && pc)) {
        ...
        let slot2
        if (c2d && (((slot2 = c2d.d) != null && !cancelledOp2[c2d.d]) || c2d.i !== undefined)) {
    ...
    if (c2p && !droppedHere) {
      ...
      if (c2p.r !== undefined || cancelledOp2[slot2]) {
  ...
  function writeHeldOp2Pick(p2Drop, outPick, w, removedOut) {
    ...
    if (c2) {
      ...
      if (!removedOut && slot != null && cancelledOp2[slot]) {
  ...
  if ((heldWrites.length || cancelledOp2.length) && !conflict) {
...
if (require.main === module) {
  type.debug = true
  const {checkValidOp, apply, compose, transform} = type
  const transformX = (left, right) => (
    [transform(left, right, 'left'), transform(right, left, 'right')]
  )

  const {normalize, tryTransform, transformNoConflict} = type
  debugger
}
