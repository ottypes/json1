  ...
  function scanOp2Drop(r1Pick, r2Pick, r2Drop, removed1) { // r1Pick, r2Pick could be null.
    ...
    if (c2d) {
      if (((slot = c2d.d) != null)) {
        ...
        log('tele r2Pick to op2 slot', slot)
    ...
    for (const key of r2Drop.children()) {
      if (typeof key === 'number') {
        ...
        log('-> p2drop', key, 'p2Mid', p2Mid, 'raw', raw)
        ...
        if (_w) {
          ...
          if (parentC && check(readCursor(_w.get()))) {
            ...
            w.mergeTree(_w.get(), (c, w) => {
              ...
              if (hasDrop(c) && removedOut) throw Error('Cant merge into removed area')
...
if (require.main === module) {
  ...
  // transform([0,["Did",{"r":true}],["his",{"d":0}],["the",{"p":0}],["went",{"r":true}]], [0,{"d":0,"p":1},[0,{"d":1}],[1,{"i":"it"}],["Did",{"p":0}]], "left")
}
