          ...
          while (p1pValid && typeof (p1k = p1Pick.getKey()) === 'number') {
            ...
            if (hp) {
              ...
              if ((c.r !== undefined && (!cancelledRemoves || !cancelledRemoves.has(c)))
                  ...
                  || (c.d != null && getComponent(heldWrites[c.d]) && hasPick(getComponent(heldWrites[c.d])))) {
...
if (require.main === module) {
  ...
  // transform(['a', [0, {r:true}], [10, {i:'hi'}]], [['a', 0, {p:0}], ['b', {d:0}]], 'right') // ok
  // transform([['a', {r:true}], ['b', 10, {i:'hi'}]], [['a', {p:0}], ['b', 0, {d:0}]], 'right') // ok
  // transform([['a', {r:true}], ['b', 10, {i:'hi'}]], ['b', 0, {i:0}], 'right') // ok
  // transform([[0,{"r":true}], [1, {"i":[""]}]], [[0,{"d":0,"p":0}],[1,{"i":23}]], "right") // ok

  // transform(['a', [0, {r:true}], [10, {i:'hi'}]], [['a', [0, {p:0}], [10, {i:'yo'}]], ['b', {d:0}]], 'right') // ok
  transform([['a', {r:true}], ['b', 0, {i:'hi'}]], [['a', {p:0}], ['b', [0, {d:0}], [1, {i:'yo'}]]], 'left') // NOPE
  // transform([['a', {r:true}], ['b', 10, {i:'hi'}]], ['b', 0, {i:0}], 'right') // ok
  // transform([[0,{"r":true}], [1, {"i":[""]}]], [[0,{"d":0,"p":0}],[1,{"i":23}]], "right") // ok

  // transform([0,{"i":[""],"r":true}], [[0,{"d":0,"p":0}],[1,{"i":23}]], "right")

  // transform([[0,{"r":true}], [10, {"i":[""]}]], [0,{"p":0,"d":0}], "right")
  // transform([0,{"i":[""],"r":true}], [1,{"i":23}], "right")

  // transform([[1,{"i":23}],[2,{"i":16}]], [0,{"i":[""],"r":true}], "left")
  // transform([[0,{"d":0,"p":0}],[1,{"i":23}],[2,{"i":16}]], [0,{"i":[],"r":true},0,{"es":[],"i":""}], "left")
}
